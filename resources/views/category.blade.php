...
<body class="sticky-header" ng-controller="ProductCategoryController" >
 
 
 
<div id="edit-category" class="modal" role="dialog" data-backdrop="static" data-keyboard="false" style="z-index:1049;width:100%;" >
                       ...
                       <form class="form-horizontal"  >
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-3 col-lg-9">
                                    <button type="button" class="btn btn-sm btn-primary" ng-click="update_category();" >Update</button>
            ...
            <div class="col-lg-12">
             ...
             <table class="table table-striped">
              ...
              <tbody>	  			  
				...
				<button type="button" class="btn btn-sm btn-primary" ng-click="set_category(category);" data-toggle="modal" data-target="#edit-category" ><i class="fa fa-edit"></i></button>
				 
				<button type="button" class="btn btn-sm btn-danger" ng-click="delete_category(category);"  ><i class="fa fa-trash-o"></i></button>				
				</td>	  
                </tr>	  
              </tbody>	  			  				
            </table>     
