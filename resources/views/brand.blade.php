...
<div id="edit-brand" class="modal" role="dialog" data-backdrop="static" data-keyboard="false" style="z-index:1049;width:100%;" >
                       ...
                       <form class="form-horizontal"  >
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-3 col-lg-9">
                                    <button type="button" class="btn btn-sm btn-primary" ng-click="update_brand();" >Update</button>
            ...
            <div class="col-lg-12">
             ...
             <table class="table table-striped">
              ...
              <tbody>	  			  
                ...
                <td style="text-align:center;" >@{{brand.brand_id}}</td>		
                <td style="text-align:center;" >@{{brand.title}}</td>										
 
				
              
                <td style="text-align:center;" >
				<button type="button" class="btn btn-sm btn-primary" ng-click="set_brand(brand);" data-toggle="modal" data-target="#edit-brand" ><i class="fa fa-edit"></i></button>
				 
				<button type="button" class="btn btn-sm btn-danger" ng-click="delete_brand(brand);"  ><i class="fa fa-trash-o"></i></button>				
				</td>	  
                </tr>	  
              </tbody>	  			  				
            </table>     
